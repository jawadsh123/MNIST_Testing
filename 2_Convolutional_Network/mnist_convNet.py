...
# loading mnist data from home directory
...
# function for creating pseudo random weight and bias variables
...
# function to create concolutional layer
def conv2d(x, W):
	return tf.nn.conv2d(x, W, strides=[1, 1, 1, 1], padding="SAME")

# function to create max pool layer
def max_pool_2x2(x):
	return tf.nn.max_pool(x, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="SAME")


# reshaping input images from [None,784] to [28,28]
